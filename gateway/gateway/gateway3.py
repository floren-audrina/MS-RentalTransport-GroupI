...
class GatewayService:
    ...
    @http('GET', '3/available_cars/<string:tanggal_mulai>/<string:tanggal_selesai>')
    ...
    @http('DELETE', '3/car_delete/<int:car_id>')
    ...
    @http('GET', '3/driver/<int:driver_id>')
    ...
    @http('DELETE', '3/driver_delete/<int:driver_id>')
    ...
    @http('GET', '3/booking/<int:booking_id>')
