...
class GatewayService:
    ...
    @http('GET', '4/available_cars/<string:tanggal_mulai>/<string:tanggal_selesai>')
    ...
    @http('DELETE', '4/car_delete/<int:car_id>')
    ...
    @http('GET', '4/driver/<int:driver_id>')
    ...
    @http('DELETE', '4/driver_delete/<int:driver_id>')
    ...
    @http('GET', '4/booking/<int:booking_id>')
