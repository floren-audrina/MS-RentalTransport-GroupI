...
class GatewayService:
    ...
    @http('GET', '0/available_cars/<string:tanggal_mulai>/<string:tanggal_selesai>')
    ...
    @http('DELETE', '0/car_delete/<int:car_id>')
    ...
    @http('GET', '0/driver/<int:driver_id>')
    ...
    @http('DELETE', '0/driver_delete/<int:driver_id>')
    ...
    @http('GET', '0/booking/<int:booking_id>')
