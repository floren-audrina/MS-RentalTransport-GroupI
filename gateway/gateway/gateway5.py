...
class GatewayService:
    ...
    @http('GET', '5/available_cars/<string:tanggal_mulai>/<string:tanggal_selesai>')
    ...
    @http('DELETE', '5/car_delete/<int:car_id>')
    ...
    @http('GET', '5/driver/<int:driver_id>')
    ...
    @http('DELETE', '5/driver_delete/<int:driver_id>')
    ...
    @http('GET', '5/booking/<int:booking_id>')
