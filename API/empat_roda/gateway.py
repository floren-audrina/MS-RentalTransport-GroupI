...
class GatewayService:
    ...
    @http('GET', '2/available_cars/<string:tanggal_mulai>/<string:tanggal_selesai>')
    ...
    @http('DELETE', '2/car_delete/<int:car_id>')
    ...
    @http('GET', '2/driver/<int:driver_id>')
    ...
    @http('DELETE', '2/driver_delete/<int:driver_id>')
    ...
    @http('GET', '2/booking/<int:booking_id>')
